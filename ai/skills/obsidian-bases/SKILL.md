...
name: obsidian-bases
description: >-
  Create and edit Obsidian Bases (.base files) — table, card, and list views
  with filters and formulas. Use when working with .base files or when the user
  mentions Bases, table views, or database-like note views.
---
